...
export const allReviews: GameReview[] = [
  ...
  },
  {
    id: 7,
    bggId: 31260,
    titleKey: 'game.agricola.title',
    rating: 4.4,
    excerptKey: 'game.agricola.excerpt',
    image: 'https://images.unsplash.com/photo-1500382017468-9049fed747ef?auto=format&fit=crop&w=500',
    fullContentKey: 'game.agricola.fullContent',
  },
  {
    id: 8,
    bggId: 3076,
    titleKey: 'game.puertoRico.title',
    rating: 4.3,
    excerptKey: 'game.puertoRico.excerpt',
    image: 'https://images.unsplash.com/photo-1589519160732-57fc498494f8?auto=format&fit=crop&w=500',
    fullContentKey: 'game.puertoRico.fullContent',
  },
  {
    id: 9,
    bggId: 102794,
    titleKey: 'game.caverna.title',
    rating: 4.5,
    excerptKey: 'game.caverna.excerpt',
    image: 'https://images.unsplash.com/photo-1518709268805-4e9042af9f23?auto=format&fit=crop&w=500',
    fullContentKey: 'game.caverna.fullContent',
  },
  {
    id: 10,
    bggId: 124742,
    titleKey: 'game.brassBirmingham.title',
    rating: 4.9,
    excerptKey: 'game.brassBirmingham.excerpt',
    image: 'https://images.unsplash.com/photo-1534438327276-14e5300c3a48?auto=format&fit=crop&w=500',
    fullContentKey: 'game.brassBirmingham.fullContent',
  },
];
