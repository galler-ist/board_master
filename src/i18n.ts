  ...
  en: {
    translation: {
      ...
      reviews: {
        ...
        passwordPlaceholder: 'Password (for deletion)',
        stars: 'Stars',
        ...
        delete: 'Delete',
        passwordPrompt: 'Please enter the password to delete this review:',
  ...
  ko: {
    translation: {
      ...
      reviews: {
        ...
        namePlaceholder: '작성자 이름',
        passwordPlaceholder: '비밀번호 (삭제용)',
        stars: '별점',
        commentPlaceholder: '이 게임에 대한 의견을 들려주세요.',
        submitReview: '리뷰 등록하기',
        submitting: '등록 중...',
        noReviews: '아직 리뷰가 없습니다. 첫 번째 리뷰를 남겨보세요!',
        delete: '삭제',
        passwordPrompt: '리뷰를 삭제하려면 비밀번호를 입력하세요:',
      ...
      game: {
        catan: {
          ...
          fullContent: `
            ...
            Catan ist bekannt für seine Mischung aus Strategie, Ressourcenmanagement und Verhandlung. Die einfachen Regeln sont leicht zu erlernen, aber die Tiefe der Strategie fesselt die Spieler über Jahre hinweg.
        ...
        wingspan: {
          ...
          fullContent: `
            ...
            Jeder Lebensraum konzentriert sich auf eine Schlüsselaktion: Nahrungsmarken erhalten (Wald), Eier legen (Grasland) oder Vogelkarten ziehen (Feuchtgebiet). Das Spiel bietet über 170 unique Vogelkarten, jede mit ihren eigenen speziellen Fähigkeiten, wunderschönen Illustrationen und interessanten Fakten.
